...
// Serve frontend files (so localhost:3000 opens your app directly)
app.use(express.static(__dirname));

// 🗄️ In-memory "database" (replace with MySQL later)
let users = [
    { id: 1, username: 'admin', password: '', role: 'admin' },
    { id: 2, username: 'alice', password: '', role: 'user' }
];

// Pre-hash known passwords for demo on startup
